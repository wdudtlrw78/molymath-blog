      ...
      <AppLayout>
        <section className="mt-minus48 mr-minus48 ml-minus48 ">
          ...
          <div className="flex justify-center items-center flex-col">
            <div className="flex justify-center items-center mt-2 opacity-80 dark:text-subDark">
            ...
            <div className="my-6 px-4 text-center">
              <div className="text-title font-bold text-article dark:text-mainDark">{title}</div>
            </div>
            <div className="flex justify-center items-center mb-8 opacity-80">
              <div className="w-1.5 h-1.5 rounded-half bg-current text-article dark:text-subDark"></div>
              <div className="w-1.5 h-1.5 rounded-half bg-current mx-2 text-article dark:text-subDark"></div>
              <div className="w-1.5 h-1.5 rounded-half bg-current text-article dark:text-subDark"></div>
            </div>
          </div>
        </section>
        <div className="prose dark:prose-dark max-w-none mb-minus16 p-4 mx-minus48 lg:p-7 lg:mx-0">
          {MDXRemoteContent}
          ...
          <span className="flex justify-center items-center text-logo text-article mt-4 dark:text-subDark">
            읽어주셔서 감사합니다!!
          </span>
        </div>
      </AppLayout>
