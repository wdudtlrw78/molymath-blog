    ...
    <>
      ...
      <AppLayout>
        <section className="mt-minus48 mr-minus48 ml-minus48 ">
          ...
          <div className="flex justify-center items-center flex-col">
            ...
            <div className="my-6 px-4 text-center">
              <div className="text-title font-medium text-article">{title}</div>
            </div>
            <div className="flex justify-center items-center mb-8">
              <div className="w-2 h-2 rounded-half bg-current text-article"></div>
              <div className="w-2 h-2 rounded-half bg-current mx-2 text-article "></div>
              <div className="w-2 h-2 rounded-half bg-current text-article"></div>
            </div>
          </div>
        </section>
        <div className="prose max-w-none mb-minus16 p-4 mx-minus48 lg:p-7 lg:mx-0">
          {MDXRemoteContent}
          <div className="flex justify-center items-center opacity-80 mt-12">
            <div className="w-2 h-2 rounded-half bg-current text-article"></div>
            <div className="w-2 h-2 rounded-half bg-current mx-2 text-article"></div>
            <div className="w-2 h-2 rounded-half bg-current text-article"></div>
          </div>
